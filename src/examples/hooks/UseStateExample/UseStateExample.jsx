...
const UseStateExample = () => {
  return (
    <Container>
      ...
      <Paragraph>
        Если же мы хотим установить значение состояния используя значение старого состояния, то мы должны
        в setState передать функцию с одним аргументом(предыдущее состояние).
      </Paragraph>
      <CountExample/>
    </Container>
  );
